...
async def test_enroll_course_fail_already_enrolled(client, set_auth, add_teacher_course_module):
    _, course, _ = add_teacher_course_module
    db_student = await add_student_model()
...
async def test_enroll_course_fail_course_not_exist(client, set_auth, add_teacher_course_module):
    _, course, _ = add_teacher_course_module
    db_student = await add_student_model()
