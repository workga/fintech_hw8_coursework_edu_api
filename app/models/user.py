...
class User(Base):
    ...
    students_courses = relationship(
        'Course', secondary='course_student',
        back_populates='students', lazy='selectin'
    )
    teachers_courses = relationship(
        'Course', secondary='course_teacher',
        back_populates='teachers', lazy='selectin'
    )
    sent_solutions = relationship(
        'Solution', foreign_keys=[Solution.student_id],
        back_populates='student', lazy='selectin'
    )
    received_solutions = relationship(
        'Solution', foreign_keys=[Solution.teacher_id],
